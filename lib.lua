...
getgenv().Aiming = {
    ...
    TargetPart = {"Head", "UpperTorso", "HumanoidRootPart", "LowerTorso", "LeftHand", "RightHand", "LeftLowerArm", "RightLowerArm", "LeftUpperArm", "RightUpperArm",  "LeftUpperLeg", "RightLowerLeg", "RightUpperLeg"},
